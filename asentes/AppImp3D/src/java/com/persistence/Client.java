...
public class Client {
    ...
    public boolean delete(Connection con) throws Exception {
        String queryString = "delete from Client where Mail=" + Utils.toString(Mail);
        Statement lStat = con.createStatement();
    ...
    public static Client getByMail(Connection con, String Mail) throws Exception {
        String queryString = "select * from Client where Mail=" + Utils.toString(Mail);
        Statement lStat = con.createStatement(
                                ResultSet.TYPE_SCROLL_INSENSITIVE, 
                                ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
    ...
    /**
     * Indique le nb de clients dans la base de données
     * @param con
     * @return le nombre de vehicules
     * @throws java.lang.Exception
    */
    public static int size(Connection con) throws Exception {
        String queryString = "select count(*) as count from Client";
        Statement lStat = con.createStatement(
                ResultSet.TYPE_SCROLL_INSENSITIVE, 
                ResultSet.CONCUR_READ_ONLY);
        ResultSet lResult = lStat.executeQuery(queryString);
